...
namespace TurTour.Hubs
{
    ...
    // - Group "admin-board": user có vai trò Admin/Organizator — nhận sự kiện đăng ký/thanh toán mới để tự refresh bảng quản lý.
    public class AppHub : Hub
    {
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            if (userId != null)
            {
                ...
                if (Context.User != null && (Context.User.IsInRole("Admin") || Context.User.IsInRole("Organizator")))
                {
